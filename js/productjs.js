...
showFeaturedProduct.onclick = function () {
    ...
    for (let i = 0; i < productArray.length; i++) {
        if (productArray[i].type == "featured") {
            str += `<li class= "product" productId="${productArray[i].productID}">
                        <a>
...
//             str2 += `<div id="productInfor" ID-target="${productArray[i].productID}">
//                             <div class="image-container">
//                                 <img src="./images/product/${productArray[i].productIMG}" alt="">
//                             </div>
//                             <div class="close-button">
//                                 <p>+</p>
//                             </div>
//                             <div class="infor-container">
//                                 <h2 class="product-title">${productArray[i].productName}
//                                 </h2>
...
// var productShow = document.getElementById("");
// productShow.addEventListener("click", showProductInfo);
...
// let previewContainer = document.querySelector(".productInfor-container");
// let previewBox = previewContainer.querySelectorAll(".productInfor");
// document.querySelectorAll(".specialProducts-list .product").forEach(product => {
//     product.onclick = () => {
//         let ID = product.getAttribute("productId");
//         showProductInfo(ID);
